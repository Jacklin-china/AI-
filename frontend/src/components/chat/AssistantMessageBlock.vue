...
<template>
  <div class="chat-row assistant"><div v-if="showMark !== false" class="assistant-mark" :class="{ live }">K</div><div class="assistant-copy"><div class="assistant-rich" v-html="rendered"></div><span v-if="live" class="stream-caret" aria-label="正在回复"></span></div></div>
</template>
